/**
 * Version:
 *     $Id: ImageStream.java,v 1.4 2008/10/10 05:51:58 troy.sadkowsky Exp $
 *
 * Revisions:
 *     $Log: ImageStream.java,v $
 *     Revision 1.4  2008/10/10 05:51:58  troy.sadkowsky
 *     permission level update
 *
 *     Revision 1.3  2008/05/30 01:52:08  troy.sadkowsky
 *     removed old code
 *
 *
 */
...
//				To Do deal with Problem with streaming image: "+imageName);
			}
		} catch(Exception e) {
//			To Do deal with Problem with streaming image: "+imageName);
		}
