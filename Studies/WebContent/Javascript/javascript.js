...
function setFromNumberPad(formName,selectName,iValue){
   document.getElementById(selectName).value =  iValue;
   document.getElementById(selectName+'numberpad').style.visibility='hidden'
}
